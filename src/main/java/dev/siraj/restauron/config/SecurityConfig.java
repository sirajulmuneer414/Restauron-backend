...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(req -> req.requestMatchers("/api/registration/*","/api/registration/*/**","/api/auth/*","/api/public/**","/ws-restauron/**", "/v3/api-docs/**",
                                "/swagger-ui/**",
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("https://restauron.vercel.app","http://localhost:5173","http://localhost:3000"));
    ...
    public WebMvcConfigurer corsConfigurer() {
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings( CorsRegistry registry) {
                registry.addMapping("/**")
                        .allowedOrigins("https://restauron.vercel.app","http://localhost:5173","http://localhost:3000")
